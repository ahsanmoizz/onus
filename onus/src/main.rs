...
fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        onus_core::cli::Commands::CodexMcp(args) => onus_core::cli::codex::run_mcp_setup(args)?,
        ...
        onus_core::cli::Commands::CursorMcp(args) => onus_core::cli::cursor::run_mcp_setup(args)?,
